...
def display_parameters():
    ...
    while True:
        ...
        # Prepare the HTML table with separate plots and map
        st.markdown("""
        <style>
        table, th, td {
        ...
        # Display icons and plot the graphs within the table for each parameter
        ...
        # Save plots as images to display them in the table
        engine_fig.savefig('engine_plot.png')
        throttle_fig.savefig('throttle_plot.png')
        depth_fig.savefig('depth_plot.png')
        speed_fig.savefig('speed_plot.png')
        slip_fig.savefig('slip_plot.png')
        ...
        output_placeholder.markdown(table_html.format(
            ...
            gps_icon=gps_icon), unsafe_allow_html=True)
