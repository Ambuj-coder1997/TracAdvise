...
def display_parameters():
    ...
    while True:
        ...
        """
        table_content += f"""
        <tr><td>Engine Torque (Nm)</td><td>{params['engine_torque']:.2f}</td></tr>
        <tr><td>Fuel Consumption (L/h)</td><td>{params['fuel_consumption']:.2f}</td></tr>
        <tr><td>Engine Power (hp)</td><td>{params['engine_power']:.2f}</td></tr>
        <tr><td>Specific Fuel Consumption (kg/hp-hr)</td><td>{params['specific_fuel_consumption']:.2f}</td></tr>
        <tr><td>Fuel Consumption per Tilled Area (L/ha)</td><td>{params['fuel_consumption_area']:.2f}</td></tr>
        <tr><td>Implement Draft (kN)</td><td>{params['implement_draft']:.2f}</td></tr>
        <tr><td>Drawbar Power (hp)</td><td>{params['drawbar_power']:.2f}</td></tr>
        <tr><td>Tractive Efficiency (%)</td><td>{params['tractive_efficiency']:.2f}</td></tr>
        """
        table_content += "</table>"
